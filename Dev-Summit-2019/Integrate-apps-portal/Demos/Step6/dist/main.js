define(["esri/WebMap", "esri/views/SceneView", "esri/portal/Portal", "esri/identity/OAuthInfo", "esri/identity/IdentityManager", "esri/layers/Layer", "esri/widgets/Expand", "esri/widgets/BasemapGallery", "esri/widgets/Search", "esri/core/urlUtils"], function (_WebMap, _SceneView, _Portal, _OAuthInfo, _IdentityManager, _Layer, _Expand, _BasemapGallery, _Search, urlUtils) {
  "use strict";
  ...
  urlUtils = _interopRequireWildcard(urlUtils);
  ...
  console.log("loc", urlUtils.urlToObject(document.location.href));
